...
const EventCard = ({ event, revealRef, className = "" }: { event: typeof englishEvents[0]; revealRef?: (el: Element | null) => void; className?: string }) => (
  <div
    ref={revealRef}
    className={`relative bg-card border rounded-xl p-5 overflow-hidden hover-lift ${className}`}
  >
    ...
    <Layout>
      ...
      <section className="py-12 md:py-16" style={{ background: "hsl(18, 8%, 16%)" }}>
        <div className="container">
          <p
            className="text-xs uppercase tracking-[0.12em] text-white/40 font-semibold mb-2 font-sans animate-fade-up"
            style={{ animationDelay: "0.1s", animationFillMode: "backwards" }}
          >Schedule</p>
          <h1
            className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-2 font-serif animate-fade-up"
            style={{ animationDelay: "0.2s", animationFillMode: "backwards" }}
          >
            Events & Schedule
          </h1>
          <p
            className="text-white/55 font-sans text-lg animate-fade-up"
      ...
      <section className="py-16 md:py-20 bg-cream">
        <div className="container max-w-3xl">
          ...
          <div className="mb-8">
            <h3 ref={reveal} className="fade-up text-sm font-bold uppercase tracking-widest text-primary mb-4 font-sans">
              English Weekends
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { title: "Men's #140", date: "September 3–6, 2026", bg: "hsl(348, 70%, 33%)" },
                { title: "Women's #138", date: "September 10–13, 2026", bg: "hsl(18, 8%, 22%)" },
              ].map((w, i) => (
                <div
                  key={w.title}
                  ref={reveal}
          ...
          <div ref={reveal} className="fade-up stagger-3">
