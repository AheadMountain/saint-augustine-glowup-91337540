      ...
      <section className="py-16 md:py-20">
        <div className="container max-w-3xl">
          <div ref={reveal} className="fade-up bg-card border rounded-xl p-6 space-y-4">
            <h2 className="text-xl font-semibold text-foreground font-serif">2026 Day of Reflection</h2>
            <div className="flex items-center gap-2 text-sm text-muted-foreground font-sans">
              <Calendar className="h-4 w-4 text-primary" />
              <span>July 20, 2026 · 8:00 AM – 3:00 PM</span>
            </div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground font-sans">
            ...
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSfhfV6FGVFRmh8XbJsfom6qmeUbcMTVLAp3STyZeMeQHu-Aaw/viewform?usp=publish-editor"
              target="_blank"
